          ...
          {MODULES.map((mod, i) => {
            ...
            return (
              <motion.div
                ...
                className={`module-card group relative flex flex-col rounded-3xl overflow-hidden border cursor-pointer
                  ${dark
              ...
              >
                {/* Accent strip */}
                <div className="h-1.5 w-full" style={{ background: `linear-gradient(90deg, ${mod.primary}, ${mod.accent})` }} />

                <div className="p-8 flex flex-col flex-1 gap-6">
                  {/* Icon + name */}
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0" style={{ backgroundColor: `${mod.accent}20` }}>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {mod.tags.map(tag => (
                      <span key={tag} className="px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-widest"
                  ...
                  <div className="flex items-center justify-end mt-2 pt-4 border-t"
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-bold text-white transition-all group-hover:gap-3"
